...
# user1.make_withdrawawl(400)
# print(user1.balance)

# print(user2.balance)
# user2.make_deposit(700)
# user2.make_deposit(1700)
# user2.make_withdrawawl(600)
# print(user2.balance)

# print(user3.balance)
# user3.make_deposit(4600)
# user3.make_withdrawawl(800)
# user3.make_withdrawawl(600)
# user3.make_withdrawawl(400)
# print(user2.balance)
