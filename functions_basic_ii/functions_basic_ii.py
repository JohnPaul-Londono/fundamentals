...
# def countDown(number = 6):
#     countList = []
#     for i in range(6, -1, -1):
#         countList += [i]
#     return countList
# print(countDown(number = 6))
...
# def values_greater_than_second(number):
#     if len(number) == 1:
#         return False
#     second_num = number[1] 
#     new_list = []
#     for i in range(0, len(number), 1):
#         if second_num < number[i]:
#             new_list.append(number[i])
#     print(len(new_list))
#     return new_list

# print (values_greater_than_second([6,3,3,4,1,7]))
